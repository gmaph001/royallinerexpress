    ...
    <div class="body">
        ...
        <div class="pay">
            <div class="form">
                ...
                <p class="exp">
                    Note: If you have confirmed incorrectly, your account will be deleted for security purposes. Please, 
                    confirm correctly!
                </p>
                <?php echo "<form action='letin.php?id=$id' class='pay_form' name='billing' method='POST' enctype='multipart/form-data'>";?>
                    <div class="pay_info">
