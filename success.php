<?php
    ...
    if($code === "101"){
        $message = "<p>Your ticket was sent to your email successfully!</p>
                    <p>Tiket imetumwa kwenye anwani yako ya barua-pepe</p>
                    <p>Thank you for choosing Royal liner Express!</p>
                    <p>Asante kwa kuchagua Royal Liner Express!</p>
                    <p>Book another ticket with us!</p>
                    <p>Kata Tiketi nyingine nasi!</p>
                    <center><a href='index.php' class='ticket'>Book (Kata)</a><br></center>";
    }
    else{
        $message = "<p>Sorry! There was a problem when sending your email!</p>
                    <p>Samahani! Kuna shida kwenye kutuma tiketi kwenye anwani yako ya barua-pepe!</p>
                    <p>Please try again by pressing try below!</p>
                    <p>Tafadhali jaribu tena!</p>
